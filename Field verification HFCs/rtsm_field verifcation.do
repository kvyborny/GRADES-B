...
***Globals
	...
	if c(username) == "wb635947" {
		...
		global rtsmdata "C:\Users\wb635947\OneDrive - WBG\Jayati Sethi's files - Pakistan GRADES-B\Data\Admin Data\GRADES B\Round 2\Data\GRADES_B_RTSM_Field_Validation_Survey_-_all_versions_-_False_-_2026-03-12-05-06-32.csv"
				
	}
	
	if c(username) == "wb630098" {
		
		global rtsmdata "C:\Users\wb630098\WBG\Jayati Sethi - SAR GIL Projects Team Folder 2023\New Impact Evaluation Candidates\Pakistan GRADES-B\Data\Admin Data\GRADES B\Round 2\Data\GRADES_B_RTSM_Field_Validation_Survey_-_all_versions_-_False_-_2026-03-12-05-06-32.csv"
...
-----------------+----------------------+----------
   1.0 to 1.5 km |       237        159 |       396 
                 |     21.29      27.94 |     23.54 
-----------------+----------------------+----------
Less than 1.0 km |       203        116 |       319 
                 |     18.24      20.39 |     18.97 
-----------------+----------------------+----------
More than 1.5 km |       673        294 |       967 
                 |     60.47      51.67 |     57.49 
-----------------+----------------------+----------
           Total |     1,113        569 |     1,682 
