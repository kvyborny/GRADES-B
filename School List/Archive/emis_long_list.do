...
*	drop intervention_dste intervention_ece master shelterless ECE Doubleshift tag
	...
	*estpost tab UC intervention ///
	...
	save "$data\Dataset\admin\Longlist\long_list_updated.dta", replace							//saving .dta file 
	export delimited using "$data\Dataset\admin\Longlist\long_list_updated.csv", replace			//saving the csv file
